...
@implementation TBMBProgressHUD {
	BOOL useAnimation;
...
+ (TBMBProgressHUD *)showHUDAddedTo:(UIView *)view animated:(BOOL)animated {
	TBMBProgressHUD *hud = [[TBMBProgressHUD alloc] initWithView:view];
	[view addSubview:hud];
	[hud show:animated];
...
+ (BOOL)hideHUDForView:(UIView *)view animated:(BOOL)animated {
	TBMBProgressHUD *hud = [TBMBProgressHUD HUDForView:view];
	if (hud != nil) {
...
+ (NSUInteger)hideAllHUDsForView:(UIView *)view animated:(BOOL)animated {
	...
	for (TBMBProgressHUD *hud in huds) {
		hud.removeFromSuperViewOnHide = YES;
		[hud hide:animated];
	}
	return [huds count];
...
+ (TBMBProgressHUD *)HUDForView:(UIView *)view {
	TBMBProgressHUD *hud = nil;
	NSArray *subviews = view.subviews;
	Class hudClass = [TBMBProgressHUD class];
	for (UIView *aView in subviews) {
		if ([aView isKindOfClass:hudClass]) {
			hud = (TBMBProgressHUD *)aView;
		}
	}
	return hud;
}
